...
$dbconn = sql_connect('localhost', 'root', '', 'bb');
if(!$dbconn) {
...
$content = mysql_fetch_array(mysqli_query($query));
...
if(isset($_POST['kirim'])) {
	...
	if (!$error) {
		...
		mysqli_query("INSERT INTO comment (article_id, name, email, comment, date) VALUES ({$id}, '{$nama}', '{$email}', '{$pesan}', NOW() )");
