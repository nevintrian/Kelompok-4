...
<body>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html"><img class="main-logo" src="rumahku.png" width="200" height="75" alt="" /></a>
                <strong><img src="rumahku1.png" alt="" /></strong>
            </div>
			<div class="nalika-profile">
				<div class="profile-dtl">
					<a href="#"><img src="img/notification/4.jpg" alt="" /></a>
					<h2>Profile<span class="min-dtn"></span></h2>
				</div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-cart-inner">
                            <div id="example-basic">
                                <h3>Data Diskusi</h3>
                                <section>
                                    <h3 class="product-cart-dn">Data Diskusi</h3>
    ...
    while ($row = mysqli_fetch_array($query))
   {
	...
	echo "<td>".$row['TGLWAKTU_DIS']."</td>";
	echo "<td>".$row['ISI_DIS']."</td>";
	echo "<td>".$row['NAMA_PT']."</td>";
	echo "<td>".$row['NAMA_PERUM']."</td>";
	echo "<td>".$row['NAMA_CLUSTER']."</td>";

	
	echo "<td><a href='proses_hapus.php?KD_DIS=".$row['KD_DIS']."'>Hapus</a></td>";
	echo "</tr>";
   }
