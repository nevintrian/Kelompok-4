<?php
    ...
    $komentar=mysqli_query($konek, "SELECT review.KD_REV, review.ISI_REV, review.TGLWAKTU_REV, review.FOTO_REV, user.KD_USER, user.USERNAME, user.STATUS, perum.KD_PERUM, perum.NAMA_PERUM, cluster.KD_CLUSTER, cluster.NAMA_CLUSTER, cluster.GAMBAR, pt.KD_PT, pt.NAMA_PT
    FROM review
    INNER JOIN cluster
    ...
    INNER JOIN user
    ON review.KD_USER=user.KD_USER");
...
<div class="panel-content">
          ...
          <div class="main-content-area">
              <div class="row">
                  <div class="streaming-table">
                    <a href="#" data-toggle="modal" data-target=".deleted" class="icon-btn pulse-grow"><i class="fa fa-trash red-bg"></i> Review terhapus</a>
                  </div>
              </div>
               <div class="row">
                    <div class="col-md-12">
                                     ...
                                     <tbody>
                                        ...
                                        ?>
                                         <tr>
                                            ...
                                            <td><?php echo $row['TGLWAKTU_REV']; ?></td>
                                            <td>
     ...
     <div class="modal fade deleted" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">Review Terhapus</h4>
            </div>
     ...
     <div class="modal fade hapus" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Hapus Review</h4>
            </div>
            <div class="modal-body">
