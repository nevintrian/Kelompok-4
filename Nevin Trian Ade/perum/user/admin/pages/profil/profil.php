                              ...
                              <div class="with-padding">                                          
                                ...
                                <div class="form-group">
                                    <?php 
                                        ...
                                        <input type="password" name="PASSWORD" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" title="Masukkan password dengan huruf besar, huruf kecil, dan angka (minimal 8 karakter)" placeholder ="Biarkan kosong jika tidak ingin mengubah password!" class="form-control" >
                                       
                                        <label for="PASSWORD1">Ulangi Password</label>
                                        <input type="password" name="PASSWORD1" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" title="Masukkan password dengan huruf besar, huruf kecil, dan angka (minimal 8 karakter)" placeholder ="Biarkan kosong jika tidak ingin mengubah password!" class="form-control" >
