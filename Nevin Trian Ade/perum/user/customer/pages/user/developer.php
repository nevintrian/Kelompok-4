<?php
    ...
    $buku = mysqli_query($konek, "SELECT user.KD_USER, user.USERNAME, user.PASSWORD, profil.KD_PROFIL, profil.NAMA_LENGKAP, profil.TGL_LAHIR, profil.JENIS_KELAMIN, profil_detil.NO_TELEPON, profil_detil.NAMA, profil.FOTO 
    FROM user INNER JOIN profil 
