                                   ...
                                   <table id="komentar" class='table table-responsive table-responsive table-striped table-hover'>
                                    ...
                                    <tbody>
                                        <?php 
                                          ...
                                          WHERE diskusi.USERNAME='$USERNAME'");
        ...
        <div class="modal-dialog">
            ...
            <?php
                        ...
                        <div class="form-group">
                          ...
                          <textarea type="text" name="ISI_DIS" class="form-control" readonly ><?php echo $row['ISI_DIS']; ?></textarea>   
                        </div>
                        <div class="form-group">
