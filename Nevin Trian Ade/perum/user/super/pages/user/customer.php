...
<div class="panel-content">
                   ...
                   <div class="col-md-12 column">
                       <?php
                        ...
                        <div role="alert" class="alert color green-bg fade in alert-dismissible">
                            ...
                            <strong>Insert Sukses!</strong> Penambahan customer baru berhasil.
                        </div>
                        <?php } else if($alert=='insert_gagal'){ ?>
                        <div role="alert" class="alert color red-bg fade in alert-dismissible">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
                            <strong>Insert Gagal!</strong> Penambahan data customer baru gagal.
                        </div>
                        <?php } else if($alert=='update_sukses'){ ?>
                        <div role="alert" class="alert color green-bg fade in alert-dismissible">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
                            <strong>Update Sukses!</strong> Pembaharuan data customer berhasil.
                        </div>
                        <?php } else if($alert=='hapus_sukses'){ ?>
                        <div role="alert" class="alert color blue-bg fade in alert-dismissible">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
                            <strong>Hapus sukses!</strong> Penghapusan data customer berhasil.
                        </div>
                        <?php } } ?>
                    </div>
          ...
          <div class="main-content-area">
               ...
               <div class="streaming-table">
                    <a href="#" data-toggle="modal" data-target=".tambah" class="icon-btn pulse-grow"><i class="fa fa-plus-square blue-bg"></i> Tambah Data Customer</a>
                  </div>
              </div>
               <div class="row">
                    <div class="col-md-12">
     ...
     <div class="modal fade" tabindex="-3" id="myModal<?php echo $data['USERNAME']; ?>" role="dialog">
        <div class="modal-dialog">
            ...
            <form role="form" action="pages/user/editcus.php" method="post" enctype="multipart/form-data">
                        <?php
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="PASSWORD" pattern="(?=.*\d)(?=.*[a-z]).{6,}" title="Masukkan password dengan huruf besar, huruf kecil, dan angka (minimal 8 karakter)" class="form-control" value="<?php echo $row['PASSWORD']; ?>">      
                        </div>
                        <div class="form-group">
     ...
     <div class="modal fade" tabindex="-3" id="myModal1<?php echo $data['USERNAME']; ?>" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
            <form role="form" action="pages/user/delcus.php" method="get">
            <?php
                        $USERNAME = $data['USERNAME']; 
                        $query_edit = mysqli_query($konek, "SELECT * FROM user WHERE USERNAME='$USERNAME'");
                        //$result = mysqli_query($conn, $query);
                        ...
                        <div class="form-group">
                          <label>Password</label>
                          <input type="text" name="PASSWORD" class="form-control" readonly value="<?php echo $row['PASSWORD']; ?>">      
                        </div>
                        <div class="form-group">
                          <label>Nama Lengkap</label>
                          <input type="text" name="NAMA_LENGKAP" class="form-control" readonly value="<?php echo $row['NAMA_LENGKAP']; ?>">      
                        </div>
                        <div class="form-group">
                          <label>Tanggal Lahir</label>
      ...
      <div class="modal fade tambah" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-body">
            <form role="form" action="pages/user/tamcus.php" method="post">
                <div class="row">
