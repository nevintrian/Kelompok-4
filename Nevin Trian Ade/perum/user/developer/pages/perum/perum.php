<?php
    ...
    $buku = mysqli_query($konek, "SELECT pt.KD_PT, pt.NAMA_PT, perum.KD_PERUM, perum.NAMA_PERUM, perum.LOKASI, perum.GAMBAR_PERUM, user.KD_USER, user.USERNAME
    FROM perum
    INNER JOIN pt
