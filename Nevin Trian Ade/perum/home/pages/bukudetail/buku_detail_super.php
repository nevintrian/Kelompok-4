...
<?php
    ...
    $queryReview = "SELECT review.KD_REV, review.ISI_REV, review.TGLWAKTU_REV, review.FOTO_REV, review.RATING, user.USERNAME, user.USERNAME, user.STATUS, perum.KD_PERUM, perum.NAMA_PERUM, cluster.KD_CLUSTER, cluster.NAMA_CLUSTER, cluster.GAMBAR, pt.KD_PT, pt.NAMA_PT
    FROM review
    INNER JOIN cluster
...
<!-- Breadcrumbs -->
    <div class="container">
      <ol class="breadcrumb">
        <li>=
          <a href="index_super.php">Beranda</a>
        </li>
        <li class="active">
...
<div class="ulasan">
    ...
    <div class="modal fade tambah" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-footer">
                <div align="center" class="col-md-4 col-md-offset-4">
                <button type="submit" class="btn btn-md" name="report1">Kirim Laporan</button>
    ...
    <div class="modal fade tambah1" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-footer">
                <div align="center" class="col-md-4 col-md-offset-4">
                <button type="submit" class="btn btn-md" name="komentar1">Kirim Diskusi</button>
    ...
    <div class="modal fade tambah2" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-footer">
                <div align="center" class="col-md-4 col-md-offset-4">
                <button type="submit" class="btn btn-md" name="ulasan1">Kirim Review</button>
