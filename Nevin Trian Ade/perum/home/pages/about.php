<!-- Breadcrumbs -->
    ...
    <section class="section-wrap about-us pb-60">
      <div class="container">
        <div class="row">
          <div class="col-sm-8">
            <h4 class="about-intro uppercase">tentang situs kami</h4>
            <p align="justify">
            carirumah.com adalah situs web untuk mencari perumahan. Terdapat fitur login untuk customer dan developer. carirumah.com dapat melakukan diskusi, review, dan report. </p>
          </div>
