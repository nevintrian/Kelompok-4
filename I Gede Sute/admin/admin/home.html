...
<!-- area sebelah pojok kiri -->
<!-- area logo di atas -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Cari Rumah.com</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- favicon
		============================================ -->
    <link rel="shortcut icon" type="image/x-icon" href="rumahku.png">
    <!-- Google Fonts
		============================================ -->
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="#"><img class="main-logo" src="rumahku.png" width="200" height="75" alt="" /></a>
                <strong><img src="rumahku1.png" alt="" /></strong>
            </div>
			<div class="nalika-profile">
				<div class="profile-dtl">
					<a href="#"><img src="img/logo1.png" alt="" /></a>
					<h2>profil <span class="min-dtn"></span></h2>
				</div>
            ...
            <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                       <ul class="submenu-angle" aria-expanded="true"></ul>
                            <li><a title="home" href="home.html"><i class="icon nalika-home icon-wrap"></i><span class="mini-sub-pro">Home</span></a>
                            </li>
                            <li><a title="Dashboard v.1" href="index.html"><span class="mini-sub-pro">Dashboard</span></a></li>
                            <li><a title="Product List" href="data-perumahan.html"><span class="mini-sub-pro">Data Perumahan</span></a></li>
                            <li><a title="Product Cart" href="data-user.html"><span class="mini-sub-pro">Data User</span></a></li>
                            <li><a class="mailbox" href="diskusi.html" ></i> <span class="mini-click-non">Diskusi</span></a></li>
                            <li><a title="View Mail" href="mailbox-view.html"><span class="mini-sub-pro">View Mail</span></a></li>
                            <li><a title="tentangkami" href="tentangkami.html"><span class="mini-sub-pro">Tentang Kami</span></a></li>
                         </ul>
                    </ul>
             </nav>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											...
											<div class="breadcomb-ctn">
												<h2>CariRumah.com</h2>
												<p>Welcome to ....<span class="bread-ntd">Sebagai Admin</span></p>
											</div>
										</div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="author-widgets-single res-mg-t-30">
                            <div class="author-wiget-inner">
                                <div class="perso-img">
                                    <img src="img/type1.jpg" class="img-circle circle-border m-b-md" alt="profile">
                                </div>
