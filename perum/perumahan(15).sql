...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 24 Des 2019 pada 02.07
...
(75, 'rizal123', 'ani123', '2019-12-18 08:39:39', '<p>baguss</p>'),
(76, 'ani123', 'rizal123', '2019-12-18 08:40:31', '<p>siap</p>');
...
(300, 0, 6, 'rizal123', 'ani123', '<p>Bagus</p>', '2019-12-18 08:38:16');
...
(1, 1, 'Villa Bintaro Asri', 'Jalan Semangka, Jember', 'tipe 30-60 (2).jpeg'),
(2, 1, 'Puri Antirogo 2', 'Jalan Sarangan, Bondowoso', 'tipe 30-60.jpeg'),
(3, 2, 'Arjasa Asri 2', 'Jalan Letnan Suprayitno, Jember', 'tipe 30-72 (2).jpeg'),
(4, 5, 'Puri Tegal Gede Residence', 'Jalan Tawang Mangu, Jember', 'd.jpg'),
(5, 3, 'Bernady Land Slawu', 'Jalan Cendrawasih, Jember', 'magnolia.jpg'),
(6, 4, 'Cendrawasih', 'Jalan Cendrawasih, Jember', 'f.jpg');
...
('adi1234', 'aa@gmail.com', '7984f89b8365426ec84385860e6973ff', 'admin', 'dsds', '2019-12-02', 'laki-laki', 'pp.jpg'),
...
('rere123', 'rere123@gmail.com', '6d70c68e412bb81b110977c84851f857', 'super', 'rere rere', '2000-09-18', 'laki-laki', 'pp.jpg'),
('reza123', 'reza123@gmail.com', 'b42d644d30c1441c97f64ee8471f83e7', 'admin', 'reza', NULL, 'laki-laki', 'pp.jpg'),
('rizal123', 'rizal@gmail.com', '49c158abbcaf49e6012ad8d70b121381', 'customer', 'Rizal', '2019-12-09', 'laki-laki', '18122019084147apple-touch-icon-114x114.png'),
...
--
ALTER TABLE `chat`
  MODIFY `KD_CHAT` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;

--
-- AUTO_INCREMENT untuk tabel `cluster`
--
ALTER TABLE `cluster`
  MODIFY `KD_CLUSTER` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;

--
-- AUTO_INCREMENT untuk tabel `diskusi`
--
ALTER TABLE `diskusi`
  MODIFY `KD_DIS` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=305;
...
--
ALTER TABLE `perum`
  MODIFY `KD_PERUM` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `review`
  MODIFY `KD_REV` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
