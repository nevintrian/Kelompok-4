<?php
    ...
    $kategori=mysqli_query($konek, "SELECT * FROM pt");
?>
                                ...
                                <table class="table table-responsive table-bordered table-condensed table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" data-toggle="modal" data-target=".kategori" data-id='<?php echo $row['KD_PT'] ?>' data-kategori='<?php echo $row['NAMA_PT'] ?>' 
                                                class="c-btn small blue-bg buzz edit_button"><i class="fa fa-pencil-square"></i></a>

                                                <a href="#" data-toggle="modal" data-target=".hapus" data-id='<?php echo $row['KD_PT'] ?>' data-kategori='<?php echo $row['NAMA_PT'] ?>'
